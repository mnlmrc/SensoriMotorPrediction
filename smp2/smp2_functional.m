function varargout = smp2_functional(what, varargin)
    ...
    switch(what)
        ...
        case 'FUNC:make_fmap'                
            ...
            % job manager:
            spmj_makefieldmap('/cifs/diedrichsen/data/SensoriMotorPrediction/smp2/fieldmaps/subj102', ...
                              ...
                              'et2', et2, ...
                              'tert', tert, ...
                              'func_dir','/cifs/diedrichsen/data/SensoriMotorPrediction/smp2/imaging_data_raw/subj102',...
                              'epi_files', epi_files);
