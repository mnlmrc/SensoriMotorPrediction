...
function c3dstruct = kinarm_load_impl(varargin)
    ...
    for x = 1:length(zipfiles)
        ...
        try
            ...
            if fbdetect()
               zipReader = ZipReaderFallback(zipfiles{x});
            else
        ...
        % This is not required for .kinarm data. The format was introduced
        % for Dex 3.9 and it recorded hand positions correctly
